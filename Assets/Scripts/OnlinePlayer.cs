...
public class OnlinePlayer : MonoBehaviour, IPlayer {
	...
	public OnlinePlayer(string name) { //initializes
		this.name = name;
	}
	...
	public void turn() { //the online player's turn
	...
	public bool Equals(IPlayer other) { //equals
	...
	// Printing this would be cheating. Method here for developing
